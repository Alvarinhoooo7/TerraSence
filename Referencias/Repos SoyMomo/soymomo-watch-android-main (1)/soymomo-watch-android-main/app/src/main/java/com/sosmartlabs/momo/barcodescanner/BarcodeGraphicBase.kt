...
internal abstract class BarcodeGraphicBase(overlay: com.sosmartlabs.momo.barcodescanner.GraphicOverlay) : com.sosmartlabs.momo.barcodescanner.GraphicOverlay.Graphic(overlay) {
    ...
    val boxRect: RectF =
        PreferenceUtils.getBarcodeReticleBox(
            overlay
        )
