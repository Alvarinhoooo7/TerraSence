...
import com.sosmartlabs.momo.utils.DeviceUtil
...
open class RTCBluetoothManager protected constructor(
    context: Context,
    ...
    private val apprtcRTCAudioManager: RTCAudioManager
     ...
     * Note that the _root_ide_package_.com.sosmartlabs.watchvideocall.soymomowebrtc.AudioManager is also involved in driving this state
     * change.
     */
    fun start() {
        ThreadUtils.checkIsOnMainThread()
    ...
    protected fun registerReceiver(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            apprtcContext.registerReceiver(receiver, filter, RECEIVER_EXPORTED)
        } else {
    ...
    private fun updateAudioDeviceState() {
        ...
        apprtcRTCAudioManager.updateAudioDeviceState()
    }
    ...
    companion object {
        ...
        /** Construction.  */
        fun create(context: Context, rtcAudioManager: RTCAudioManager): RTCBluetoothManager {
            Log.d(TAG, "create" + DeviceUtil.getThreadInfo())
            return RTCBluetoothManager(context, rtcAudioManager)
        }
    }
    ...
    init {
        ...
        apprtcRTCAudioManager = rtcAudioManager
