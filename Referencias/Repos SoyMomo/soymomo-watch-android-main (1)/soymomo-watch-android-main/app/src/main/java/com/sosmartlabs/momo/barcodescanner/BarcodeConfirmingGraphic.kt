...
internal class BarcodeConfirmingGraphic(overlay: com.sosmartlabs.momo.barcodescanner.GraphicOverlay, private val barcode: Barcode) :
    com.sosmartlabs.momo.barcodescanner.BarcodeGraphicBase(overlay) {
    ...
    override fun draw(canvas: Canvas) {
        ...
        val sizeProgress =
            com.sosmartlabs.momo.barcodescanner.PreferenceUtils.getProgressToMeetBarcodeSizeRequirement(
                overlay,
                barcode
            )
        val path = Path()
