...
/**
 * Notification handler for smart detections
 * @param context Context for launching notification
 * @param userRepository Repository for users
 * @param tabletRepository Repository for tablets
 */
class SmartDetectionNotificationHandler @Inject constructor(@ApplicationContext context: Context,
                                                            userRepository: UserRepository,
                                                            tabletRepository: TabletRepository
):
    DugNotificationHandler(context, userRepository, tabletRepository)  {
    override val notificationId: Int = Constants.notificationSmartDetection
    override val notificationDestinationId: Int = R.id.tabletFragmentDugUnified
    override var notificationContentTitleId: Int = R.string.notification_smart_detection_title
    override var notificationContextTextId: Int = R.string.notification_smart_detection_text
    override val notificationErrorText: String = "Error on creating notification for smart detection received instruction"
