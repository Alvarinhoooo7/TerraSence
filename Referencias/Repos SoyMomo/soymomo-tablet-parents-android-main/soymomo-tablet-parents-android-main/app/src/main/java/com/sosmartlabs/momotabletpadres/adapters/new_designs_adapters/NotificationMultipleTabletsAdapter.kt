...
import com.sosmartlabs.momotabletpadres.databinding.ItemNotificationMultiplesTabletsBinding
...
class NotificationMultipleTabletsAdapter(private val mContext: Context):
    PagingDataAdapter<NotificationEntity, NotificationMultipleTabletsAdapter.NotificationViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NotificationViewHolder {
        return NotificationViewHolder(ItemNotificationMultiplesTabletsBinding.inflate(
    ...
    class NotificationViewHolder(private val binding: ItemNotificationMultiplesTabletsBinding, private val context: Context, private val listener: Listener) :
        ...
        private val notificationIcon get() = binding.notificationIcon
        ...
        fun bind(notification: NotificationEntity?, position: Int) {
            ...
            setNotificationTabletProfileImage(notification)
        }
        ...
        private fun setNotificationIcon(notification: NotificationEntity?) {
            notificationIcon.loadAppIcon(
                notification?.category?.iconUrl,
                notification?.category?.categoryName
            )
        }

        private fun setNotificationTabletProfileImage(notification: NotificationEntity?) {
            Glide.with(context)
                .load(notification?.tablet?.profilePicture?.url)
                .error(R.drawable.default_profile_pic)
                .into(notificationTabletProfileImage)
        }
