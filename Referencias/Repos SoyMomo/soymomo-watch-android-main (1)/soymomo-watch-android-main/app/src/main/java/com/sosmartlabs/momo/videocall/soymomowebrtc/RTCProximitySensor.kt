...
class RTCProximitySensor private constructor(
    ...
    fun start(): Boolean {
        ...
        Timber.d("start" + DeviceUtil.getThreadInfo())
    ...
    fun stop() {
        threadChecker.checkIsOnValidThread()
        Timber.d("stop" + DeviceUtil.getThreadInfo())
    ...
    override fun onSensorChanged(event: SensorEvent) {
        ...
        Timber.d("onSensorChanged" + DeviceUtil.getThreadInfo()
                .toString() + ": " + "accuracy=" + event.accuracy.toString() + ", timestamp=" + event.timestamp.toString() + ", distance="
                    + event.values[0])
    }
    ...
    init {
        Timber.d("AppRTCProximitySensor" + DeviceUtil.getThreadInfo())
