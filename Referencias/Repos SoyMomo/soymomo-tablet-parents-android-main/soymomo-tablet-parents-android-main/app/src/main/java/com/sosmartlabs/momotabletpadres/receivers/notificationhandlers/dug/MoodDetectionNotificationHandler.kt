...
/**
 * Notification handler for mood detections
 * @param context Context for launching notification
 * @param userRepository Repository for users
 * @param tabletRepository Repository for tablets
 */
class MoodDetectionNotificationHandler @Inject constructor(@ApplicationContext context: Context,
                                                           userRepository: UserRepository,
                                                           tabletRepository: TabletRepository
):
    DugNotificationHandler(context, userRepository, tabletRepository) {
    override val notificationId: Int = Constants.notificationMoodDetection
    override val notificationDestinationId: Int = R.id.tabletFragmentDugUnified
    override var notificationContentTitleId: Int = R.string.notification_mood_detection_title
    override var notificationContextTextId: Int = R.string.notification_mood_detection_text
    override val notificationErrorText: String = "Error on creating notification for mood detection"
