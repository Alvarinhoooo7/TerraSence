...
/**
 * Notification handler for explicit music detection
 * @param context Context for launching notification
 * @param userRepository Repository for users
 * @param tabletRepository Repository for tablets
 */
class ExplicitMusicNotificationHandler @Inject constructor(@ApplicationContext context: Context,
                                                          userRepository: UserRepository,
                                                          tabletRepository: TabletRepository
):
    DugNotificationHandler(context, userRepository, tabletRepository) {
    override val notificationId: Int = Constants.notificationExplicitMusicDetection
    override val notificationDestinationId: Int = R.id.tabletFragmentDugUnified
    override var notificationContentTitleId: Int = R.string.notification_explicit_music_detection_title
    override var notificationContextTextId: Int = R.string.notification_explicit_music_detection_text
    override val notificationErrorText: String = "Error on creating notification for explicit music detection"
