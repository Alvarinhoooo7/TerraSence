...
class RTCAudioManager private constructor(context: Context) {
    ...
    @Nullable
    private var proximitySensor: RTCProximitySensor? = null
    ...
    private inner class WiredHeadsetReceiver : BroadcastReceiver() {
        ...
        override fun onReceive(context: Context?, intent: Intent) {
            val state =
                intent.getIntExtra("state", STATE_UNPLUGGED)
            val microphone =
                intent.getIntExtra("microphone", HAS_NO_MIC)
            val name = intent.getStringExtra("name")
            Timber.d(
                "WiredHeadsetReceiver.onReceive" + DeviceUtil.getThreadInfo()
    ...
    fun getAudioDevices(): MutableSet<AudioDevice?> {
        ThreadUtils.checkIsOnMainThread()
    ...
    init {
        ...
        val r = Runnable { onProximitySensorChangedState() }
        proximitySensor = RTCProximitySensor.create(context, r)
        Timber.d("defaultAudioDevice: $defaultAudioDevice")
        DeviceUtil.logDeviceInfo(TAG)
    }
}